var howClose, txtbx, hint, tint, hintbody;
                ...
                req.onreadystatechange = function () {
                    if (req.readyState == 4 && req.status == 200) {
                        ...
                        if(req.responseText == ""){
                            ...
                            document.getElementById('closeness').innerHTML = "We're having a little trouble with our server. Please try again in a minute ^-^";
                            return;
                        }
