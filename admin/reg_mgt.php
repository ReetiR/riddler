...
$sql_student="SELECT * FROM `users` ORDER BY `id` ASC";
$rs_student= $mysqli->query($sql_student);
$num_rows=$rs_student->num_rows;
...
$sql_student.="  LIMIT $not_found,$list"; 
$resnew =$mysqli->query($sql_student);
...
<table align="left" border="0" cellpadding="0" cellspacing="0" width="90%"  >
		...
		<td align="center" valign="top" width="68%">
					...
					<table class="tab_sty1" align="center" border="0" cellpadding="0" cellspacing="1" width="100%">
								...
								<td colspan="6" class="mysty2" align="center" bgcolor="#999999"><font color="#FFFFFF" size="2"><b>Registration Details</b></font></td>
								</tr>
								...
								<td class="mysty1"  align="center"><b>Phone No.</b></td>
								<td class="mysty1"  align="center"><b>Status</b></td>
								<td class="mysty1"  align="center"><b>Last Level</b></td>
...
<td class="mysty1" align="center"><?php echo $row_student['phoneno']; ?></td>
<td class="mysty1" align="center"><?php echo $row_student['status']; ?></td>
<td class="mysty1" align="center"><?php echo $row_student['last_level']; ?></td>	   
						
<td align="center" ><a href="reg_edit.php?id=<?php echo $row_student['id']; ?>" class="A3"  ><img src="../images/edit.png" border="0"></a>&nbsp;&nbsp;<a href="reg_delete.php?id=<?php echo $row_student['id']; ?>" class="A3" onClick="return(confirm('Do you really want to Delete?'))"  ><img src="../images/delete.png" border="0"></a></td>							      
</tr>
<?php
}
?>								
